...
namespace PQCDEMO
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void AdjustGroupLayout()
        {
            ...
            int currentHeight = 0;
            var groupBoxes = new List<GroupBox> { _xgroupBox, _ygroupBox, _zgroupBox, groupBox10 };
